function Add-WizardPassword {
    <#
    .SYNOPSIS
    Adds a secure password input control to a wizard step.
    ...
    .EXAMPLE
    Add-WizardPassword -Step "Security" -Name "AdminPassword" -Label "Administrator Password" -Mandatory
    
    Adds a required password field.
    
    .EXAMPLE
    Add-WizardPassword -Step "Security" -Name "Password" -Label "Password" -MinLength 8 -ShowRevealButton $false
    
    Adds a password field with minimum length validation and no reveal button.
    
    .EXAMPLE
    Add-WizardPassword -Step "Security" -Name "Password" -Label "Password" `
    ...
    .OUTPUTS
    WizardControl object representing the created password input.
    #>
    [CmdletBinding()]
    param(
    ...
    process {
        try {
            ...
            $control = [WizardControl]::new($Name, $Label, 'Password')
        ...
        Write-Verbose "Add-WizardPassword completed for: $Name"
    }
}

function Add-WizardDropdown {
    <#
    .SYNOPSIS
    Adds a dropdown selection control to a wizard step.
    ...
    .EXAMPLE
    Add-WizardDropdown -Step "Config" -Name "Environment" -Label "Target Environment:" -Choices @('Development', 'Testing', 'Production') -Mandatory
    
    Adds a required dropdown for environment selection.
    
    .EXAMPLE
    Add-WizardDropdown -Step "Config" -Name "LogLevel" -Label "Log Level:" -Choices @('Error', 'Warning', 'Information', 'Debug') -Default 'Information'
    
    Adds a dropdown with a default selection.
    
    .EXAMPLE
    Add-WizardDropdown -Step "Config" -Name "CustomOption" -Label "Custom Option:" -Choices @('Option1', 'Option2', 'Option3') -Editable
    
    Adds an editable dropdown that allows custom values.
    
    .EXAMPLE
    Add-WizardDropdown -Step "Config" -Name "Region" -Label "Region:" -ScriptBlock {
        param($Environment)
    ...
    .OUTPUTS
    WizardControl object representing the created dropdown.
    ...
    process {
        try {
            ...
            # Create the control
            $control = [WizardControl]::new($Name, $Label, 'Dropdown')
        ...
        Write-Verbose "Add-WizardDropdown completed for: $Name"
    }
}

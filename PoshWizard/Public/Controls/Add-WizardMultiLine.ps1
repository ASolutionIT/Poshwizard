function Add-WizardMultiLine {
    <#
    .SYNOPSIS
    Adds a multi-line text area to a wizard step.
    ...
    .EXAMPLE
    Add-WizardMultiLine -Step "Config" -Name "Notes" -Label "Deployment Notes" -Rows 6

    Adds a multi-line text area showing six rows by default.

    .OUTPUTS
    WizardControl object representing the created multi-line text area.
    ...
    process {
        ...
        Write-Verbose "Add-WizardMultiLine completed for: $Name"
    }
}
